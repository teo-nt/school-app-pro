...
public class AdminStudentsMenu extends JFrame {
	...
	public AdminStudentsMenu() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminStudentsMenu.class.getResource("/resources/eduv2.png")));
		...
		searchBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.getAdminStudentsMenu().setEnabled(false);
		...
		closeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.getAdminStudentsMenu().setVisible(false);
			}
		});
		closeBtn.setForeground(new Color(0, 0, 255));
		closeBtn.setFont(new Font("Tahoma", Font.BOLD, 14));
		closeBtn.setBounds(287, 327, 108, 43);
